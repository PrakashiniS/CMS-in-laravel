...
<body>
                                        ...
                                        <a class="nav-link" data-toggle="tab" href="#home" role="tab" aria-selected="false">
                                            ...
                                            <div id="navref2">
                                                <span class="hidden-xs-down">
                                                    ...
                                                    <b>&nbsp Pending Work ({{$facpending}})</b>
                                                </span>
                                            </div>
                                        </a>
                                        ...
                                        <a class="nav-link" data-toggle="tab" href="#inprogress" role="tab" aria-selected="false">
                                            ...
                                            <div id="navref3">
                                                <span class="hidden-xs-down">
                                                    ...
                                                    <b>&nbsp Work-In Progress ({{$facworkinprog}})</b>
                                                </span>
                                            </div>
                                        </a>
                                        ...
                                        <a class="nav-link" data-toggle="tab" href="#completed" role="tab">
                                            ...
                                            <div id="navref4">
                                                <span class="hidden-xs-down">
                                                    ...
                                                    <b>&nbsp Completed Work ({{$faccompleted}})</b>
                                                </span>
                                            </div>
                                        </a>
                                        ...
                                        <a class="nav-link" data-toggle="tab" href="#parents" role="tab">
                                            ...
                                            <div id="navref5">
                                                <span class="hidden-xs-down">
                                                    ...
                                                    <b>&nbsp Rejected Work ({{$facrejected}})</b>
                                                </span>
                                            </div>
                                        </a>
                                        ...
                                        <a class="nav-link" data-toggle="tab" href="#reassign" role="tab">
                                            ...
                                            <div id="navref6">
                                                <span class="hidden-xs-down">
                                                    ...
                                                    <b>&nbsp Reassigned Work ({{$facreassigned}})</b>
                                                </span>
                                            </div>
                                        </a>
                                                            ...
                                                            <div class="bo">
                                                                <div class="content1">
                                                                    <div class="stats-box text-center p-3"
                                                                        ...
                                                                        <h1 class="m-b-0 m-t-5">{{$facpending}}</h1>
                                                            ...
                                                            <div class="bo">
                                                                <div class="content1">
                                                                    <div class="stats-box text-center p-3"
                                                                        ...
                                                                        <h1 class="m-b-0 m-t-5">{{$facworkinprog}}</h1>
                                                            ...
                                                            <div class="bo">
                                                                <div class="content1">
                                                                    <div class="stats-box text-center p-3"
                                                                        ...
                                                                        <h1 class="m-b-0 m-t-5">{{$faccompleted}}</h1>
                                                            ...
                                                            <div class="bo">
                                                                <div class="content1">
                                                                    <div class="stats-box text-center p-3"
                                                                        ...
                                                                        <h1 class="m-b-0 m-t-5">{{$facreassigned}}</h1>
                                                ...
                                                <div>
                                                    <form id="addnewuser" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="hidden" id="hidden_faculty_id" value="11111111">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="user" class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                @php $facp=1; @endphp
                                                                @foreach($facpend as $pe)
                                                                    <tr>
                                                                        <td class="text-center">{{$facp++}}</td>
                                                                        <td class="text-center">{{$pe->id}}</td>
                                                                        <td class="text-center">{{$pe->venue_name}}</td>
                                                                      
                                                                        <td class="text-center">{{$pe->type_of_problem}}</td>
                                                                        <td class="text-center">{{$pe->problem_description}}</td>
                                                                        <td class="text-center">{{$pe->date_of_reg}}</td>
                                                                        <td class="text-center">
                                                                            <button type="button" class="btn showImage" value="{{$pe->id}}" data-task-id='{{$pe->id}}'>
                                                                        ...
                                                                        <td class="text-center">
                                                                                ...
                                                                                <center>
                                                                                    <button class="btn btndelete btn-danger" type="button" value="">
                                                                                        <i class="fas fa-times"></i>
                                                                                    </button>
                                                                                </center>
                                                                            
                                                                                <span class="badge bg-success" style="font-size: 1.2em; color: #000; padding: 0.25em 0.5em;"></span>
                                                ...
                                                <table id="ProgressTable" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"></td>
                                                                <td class="text-center">
                                                                    <button type="button" class="btn btn-light showWorkerDetails" value="">
                                                                ...
                                                                <td class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-info feedbackBtn" data-problem-id="" data-bs-toggle="modal" data-bs-target="#feedback_modal">Feedback</button>
                                        ...
                                        <table id="RejectionTable" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"></td>
                                                        <td class="text-center">
                                                            <span class="badge" style="background-color: #ff6666; font-size: 1.2em; color: #000000; padding: 0.25em 0.5em;"></span>
                                                        </td>
                                                        <td class="text-center"></td>
                                                    </tr>
                                                ...
                                                <table id="reassignTable" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"></td>
                                                                <td class="text-center">
                                                                    <button type="button" class="btn btn-info showWorkerDetails" value="">View</button>
                                                                </td>
                                                                <td></td>
                                                            </tr>
    ...
    <script>
        ...
        $(document).on('click', '#viewImageButton', function() {
            var imageSrc = $('#preview_image').attr('src','uploads/');
            if (imageSrc) {
                $('#preview_images').show();
            } else {
